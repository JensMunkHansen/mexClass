 ...
 *                                                                            *
 * $Id: aperture.cpp,v 1.59 2012-07-05 21:10:38 jmh Exp $
 *                                                                            *
 * $Author: jmh $                                                             *
 *                                                                            *
 ...
 *----------------------------------------------------------------------------*
 *                                                                            *
 * This file is part of Beamformation Toolbox 3 (BFT3)                        *
 *                                                                            *
...
Aperture::Aperture(size_t n_elements, float_type width, float_type kerf,
    ...
    float_type theta_pitch = asin (width/radius) + asin (kerf/radius);
